    ...
    return (
        <section className="py-24 bg-white dark:bg-[#020617] relative overflow-hidden transition-colors duration-500">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-[20%] right-[10%] w-[500px] h-[500px] bg-blue-500/5 dark:bg-blue-500/10 rounded-full blur-[100px]"></div>
                <div className="absolute bottom-[20%] left-[10%] w-[500px] h-[500px] bg-purple-500/5 dark:bg-purple-500/10 rounded-full blur-[100px]"></div>
            </div>

            <div className="container mx-auto px-6 lg:px-24 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-500/30 mb-6">
                        <Zap size={14} className="text-blue-600 dark:text-blue-400" />
                        <span className="text-xs font-bold text-blue-700 dark:text-blue-300 uppercase tracking-wider">Powerful Features</span>
                    </div>
                    <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900 dark:text-white">
                        Everything you need to <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">land your dream job</span>
                    </h2>
                ...
                <div className="grid lg:grid-cols-12 gap-16 items-center">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h3 className={`text-xl font-bold transition-colors ${activeFeature === index ? 'text-blue-700 dark:text-blue-400' : 'text-slate-900 dark:text-white'
                                            }`}>
                                            {feature.title}
                                        </h3>
                    ...
                    <div className="lg:col-span-7 relative group perspective-1000">
                        {/* Background Accent */}
                        <div className="absolute -inset-4 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/20 dark:to-purple-900/20 rounded-[3rem] blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>

                        <div className="bg-[#1e1e2e] rounded-2xl shadow-2xl border border-slate-800 overflow-hidden transform group-hover:rotate-y-2 transition-transform duration-700 ease-out relative z-10">
                            {/* Fake OS Header */}
                            <div className="flex items-center justify-between px-6 py-4 bg-[#181825] border-b border-gray-800">
                            ...
                            <div className="flex h-[500px]">
                                {/* Editor Sidebar */}
                                <div className="w-1/3 border-r border-gray-800 p-6 space-y-6 hidden md:block bg-[#1e1e2e]">
                                    ...
                                    <div className="pt-6 space-y-4">
                                        ...
                                        <div className="space-y-3">
                                            <div className="h-10 w-full bg-blue-600/10 text-blue-400 text-xs font-bold px-3 flex items-center justify-between rounded-lg border border-blue-500/20 shadow-[0_0_15px_rgba(37,99,235,0.1)]">
                                ...
                                {/* Main Preview Area */}
                                <div className="flex-1 bg-[#11111b] p-8 overflow-hidden relative">
                                    <div className="bg-white w-full h-[600px] shadow-2xl rounded-sm p-8 origin-top scale-95 transform transition-transform duration-700">
                                        ...
                                        <div className="space-y-5">
                                            ...
                                            <div className="pt-6">
                                                <div className="h-16 w-full border-2 border-dashed border-blue-200 bg-blue-50/50 rounded-xl flex items-center justify-center gap-2 text-blue-400 font-bold text-xs uppercase tracking-widest hover:bg-blue-50 transition-colors cursor-pointer">
